...
- Enchants such as protection and sharpness are effective on **all 6 main item slots** (ie. 4 armor slots, main hand and offhand) . This is because, the total protection level and sharp level is calculated by  (Sum of all prot or sharp values across six main slots)/ 4 . This is why dungeons can drop swords with protection 4 or armor with sharpness. 

- Experience can be earned from killing elite mobs, the formula being elitemoblevel ^2. 
